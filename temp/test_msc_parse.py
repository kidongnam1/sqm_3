...
BL  = r'D:\program\SQM_inventory\SQM 4.13 입고\MEDUW9018104 ANㅡmsc\2200034702 BL.pdf'
FA  = r'D:\program\SQM_inventory\SQM 4.13 입고\MEDUW9018104 ANㅡmsc\2200034702 FA.PDF'
PL  = r'D:\program\SQM_inventory\SQM 4.13 입고\MEDUW9018104 ANㅡmsc\2200034702_PackingList1.pdf'
DO  = r'D:\program\SQM_inventory\SQM 4.13 입고\MEDUW9018104 ANㅡmsc\MEDUW9018104 DO.pdf'

from parsers.document_parser_modular.parser import DocumentParser
p = DocumentParser()

print('=== BL 파싱 ===')
bl = p.parse_bl(BL, carrier_id='MSC')
if bl:
...
print()
print('=== PL 파싱 ===')
pl = p.parse_packing_list(PL, carrier_id='MSC')
if pl:
...
print()
print('=== D/O 파싱 ===')
do = p.parse_do(DO, carrier_id='MSC')
if do:
