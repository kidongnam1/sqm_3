...
- ONE DO test now active (removed skip, added expected values with mrn/msn)
- 16 tests total: 16 passed, 0 skipped - full 4x4 matrix covered
- HAPAG PL: folio=3812291 lots=20 containers=5 gross_wt=102625 maxibag=200

Verified: pytest tests/test_parser_regression.py -> 16 passed in 1.55s"

echo [6] Push to sqm_3...
