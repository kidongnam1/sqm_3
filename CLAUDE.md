...
> **수정일:** 2026-04-27 KST (v864.3 → v865 버전 업그레이드, 회귀 테스트 Phase 시작 / 대용량 JS 수정 규칙 추가)
> **등록자:** Nam Ki-dong (사장님)
...
**v865 프로젝트 작업 시 반드시 "이 프로젝트 폴더(현재 폴더 = `Claude_SQM_v864_3\`)"의 내용을 전부 참조·반영한다. 절대경로 하드코딩 금지.**
