...
class TestDailyCacheIntegration:
    ...
    def test_non_transient_error_not_recorded(self):
        ...
        fake_gemini = MagicMock()
        fake_gemini.parse_invoice.side_effect = ValueError("non-transient error")
        ...
        with patch(
            ...
            with patch(
                ...
                with pytest.raises(ValueError):
                    mpp.parse_invoice("fake.pdf")

        assert _DAILY_CACHE["failures"] == initial_failures, "비-transient 는 카운터 증가 안 함"
